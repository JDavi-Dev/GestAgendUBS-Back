...
class Profissional(db.Model):
    ...
    horarios_disponiveis = relationship("Horario", back_populates="profissional", cascade="all, delete-orphan")

    def __init__(self, nome: str, registro: str, especialidade: str, telefone: str, email: str, senha: str, ativo: bool):
        self.nome = nome
